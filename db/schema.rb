...
ActiveRecord::Schema.define(version: 20180630185928) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "score_group", default: 0
    t.integer "score_sixteen", default: 0
    t.integer "score_quarters", default: 0
    t.integer "score_semis", default: 0
    t.integer "score_final", default: 0
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
